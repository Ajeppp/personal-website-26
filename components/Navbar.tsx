                ...
                <div className="sm:hidden mt-2 px-4 pb-4">
                    <div className="bg-white/80 dark:bg-black/28 border border-white/8 dark:border-white/6 rounded-xl shadow-md p-4">
                        <ul className="flex flex-col gap-3 text-base">
                            <li><Link href="/about" onClick={() => setOpen(false)} className="block">About</Link></li>
                            <li><Link href="/" onClick={() => setOpen(false)} className="block">Projects</Link></li>
                            <li><Link href="/contact" onClick={() => setOpen(false)} className="block">Contact</Link></li>
                        </ul>
                    </div>
                </div>
            )}
